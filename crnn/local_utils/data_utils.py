...
class TextFeatureIO(object):
    ...
    """
    def __init__(self, char_dict_path=ops.join(os.getcwd(), 'crnn/data/char_dict/char_dict.json'),
                 ord_map_dict_path=ops.join(os.getcwd(), 'crnn/data/char_dict/ord_map.json')):
        """
